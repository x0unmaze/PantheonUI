...
from .node_typing import IO, InputTypeDict, PantheonNodeABC, CheckLazyMixin


class UnetApplyFunction(Protocol):
    """Function signature protocol on pantheon.model_base.BaseModel.apply_model"""
