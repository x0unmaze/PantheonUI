...
import torch
import pantheon.ldm.flux.layers
import pantheon.ldm.modules.diffusionmodules.mmdit
...
from pantheon.ldm.flux.layers import (
    DoubleStreamBlock,
    EmbedND,
    LastLayer,
    MLPEmbedder,
...
class HunyuanVideo(nn.Module):
    ...
    def __init__(self, image_model=None, final_layer=True, dtype=None, device=None, operations=None, **kwargs):
        ...
        self.img_in = pantheon.ldm.modules.diffusionmodules.mmdit.PatchEmbed(None, self.patch_size, self.in_channels, self.hidden_size, conv3d=True, dtype=dtype, device=device, operations=operations)
