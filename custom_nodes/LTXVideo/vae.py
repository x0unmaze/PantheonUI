...
class LTXVVAE(pantheon.sd.VAE):
    def __init__(self, decode_timestep=0.05, decode_noise_scale=0.025, seed=42):
        self.device = pantheon.model_management.vae_device()
        self.offload_device = pantheon.model_management.vae_offload_device()
    ...
    # However in Pantheon the convension is n, h, w, c.
    def encode(self, pixel_samples):
        ...
        ).to(pantheon.model_management.get_torch_device())
        return latents


@pantheon_node(name="Add VAE Decoder Noise")
class DecoderNoise:
    @classmethod
    def INPUT_TYPES(cls):
        return {
