...
class LTXVModelConfig:
    def __init__(self, latent_channels, dtype):
        ...
        self.latent_format = pantheon.latent_formats.LatentFormat()
...
class LTXVSampling(torch.nn.Module, pantheon.model_sampling.CONST):
...
class LTXVModel(pantheon.model_base.BaseModel):
