...
def calc_lora_model(model_diff, rank, prefix_model, prefix_lora, output_sd, lora_type, bias_diff=False):
    pantheon.model_management.load_models_gpu([model_diff], force_patch_weights=True)
...
class LoraSave:
    ...
    @classmethod
    def INPUT_TYPES(s):
        return {"required": {"filename_prefix": ("STRING", {"default": "loras/PantheonUI_extracted_lora"}),
    ...
    def save(self, filename_prefix, rank, lora_type, bias_diff, model_diff=None, text_encoder_diff=None):
        ...
        pantheon.utils.save_torch_file(output_sd, output_checkpoint, metadata=None)
        return {}
