...
class LCM(pantheon.model_sampling.EPS):
...
class X0(pantheon.model_sampling.EPS):
    def calculate_denoised(self, sigma, model_output, model_input):
        return model_output

class ModelSamplingDiscreteDistilled(pantheon.model_sampling.ModelSamplingDiscrete):
...
class ModelSamplingDiscrete:
    ...
    def patch(self, model, sampling, zsnr):
        ...
        sampling_base = pantheon.model_sampling.ModelSamplingDiscrete
        if sampling == "eps":
            sampling_type = pantheon.model_sampling.EPS
        elif sampling == "v_prediction":
            sampling_type = pantheon.model_sampling.V_PREDICTION
        elif sampling == "lcm":
            sampling_type = LCM
...
class ModelSamplingStableCascade:
    ...
    def patch(self, model, shift):
        ...
        sampling_base = pantheon.model_sampling.StableCascadeSampling
        sampling_type = pantheon.model_sampling.EPS
...
class ModelSamplingSD3:
    ...
    def patch(self, model, shift, multiplier=1000):
        ...
        sampling_base = pantheon.model_sampling.ModelSamplingDiscreteFlow
        sampling_type = pantheon.model_sampling.CONST
...
class ModelSamplingFlux:
    ...
    def patch(self, model, max_shift, base_shift, width, height):
        ...
        sampling_base = pantheon.model_sampling.ModelSamplingFlux
        sampling_type = pantheon.model_sampling.CONST
...
class ModelSamplingContinuousEDM:
    ...
    def patch(self, model, sampling, sigma_max, sigma_min):
        ...
        if sampling == "eps":
            ...
            sampling_type = pantheon.model_sampling.EDM
            sigma_data = 0.5
        elif sampling == "v_prediction":
            sampling_type = pantheon.model_sampling.V_PREDICTION
            ...
            sampling_type = pantheon.model_sampling.EDM
            sigma_data = 0.5
            latent_format = pantheon.latent_formats.SDXL_Playground_2_5()

        class ModelSamplingAdvanced(pantheon.model_sampling.ModelSamplingContinuousEDM, sampling_type):
            pass
...
class ModelSamplingContinuousV:
    ...
    def patch(self, model, sampling, sigma_max, sigma_min):
        ...
        class ModelSamplingAdvanced(pantheon.model_sampling.ModelSamplingContinuousV, sampling_type):
            pass
