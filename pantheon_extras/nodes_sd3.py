...
import nodes
import torch
import pantheon_extras.nodes_slg
...
class TripleCLIPLoader:
    ...
    def load_clip(self, clip_name1, clip_name2, clip_name3):
        ...
        clip = pantheon.sd.load_clip(ckpt_paths=[clip_path1, clip_path2, clip_path3], embedding_directory=folder_paths.get_folder_paths("embeddings"))
        return (clip,)
...
class SkipLayerGuidanceSD3(pantheon_extras.nodes_slg.SkipLayerGuidanceDiT):
    '''
