import pantheon_extras.nodes_model_merging

class ModelMergeSD1(pantheon_extras.nodes_model_merging.ModelMergeBlocks):
...
class ModelMergeSDXL(pantheon_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeSD3_2B(pantheon_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeAuraflow(pantheon_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeFlux1(pantheon_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeSD35_Large(pantheon_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeMochiPreview(pantheon_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
...
class ModelMergeLTXV(pantheon_extras.nodes_model_merging.ModelMergeBlocks):
    CATEGORY = "advanced/model_merging/model_specific"
