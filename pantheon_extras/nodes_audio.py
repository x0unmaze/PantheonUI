...
class SaveAudio:
    ...
    def INPUT_TYPES(s):
        return {"required": { "audio": ("AUDIO", ),
                              "filename_prefix": ("STRING", {"default": "audio/PantheonUI"})},
    ...
    def save_audio(self, audio, filename_prefix="PantheonUI", prompt=None, extra_pnginfo=None):
